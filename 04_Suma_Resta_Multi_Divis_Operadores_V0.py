...
multiplicar = 7 * 9 * 5
dividir = 7 / 9 / 5
#Arriba sumamos, restamos, multiplicamos y dividimos individualmente los 3 mismos numeros
print("Suma: ", sumar, "\nResta: " , restar , "\nMultiplicacion: " , multiplicar , "\nDivision: " , dividir)
#Imprimimos todos los resultados, usamos coma para concatenar ya que si usamos + se podrian generar errores al sumar numeros y strings
...
#5
operacionrara = (10 + 5 - 15) / 17 #Primera opcion planteada
opc2 =10 / 5 + 15 - 17 #Segunda opcion planteada sin parentesis
#Nos dieron los numeros y debiamos de elegir 3 simbolos aritmeticos para que el resultado diera 0
print("Da 0?: ", operacionrara)#Corroboramos resultado
print("Da 0?: ", opc2)#Corroboramos resultado 2
